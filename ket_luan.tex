...
\subsection{Về quyết định chỉ dùng chế độ resize}
...
\subsection{Hiện thực hóa tăng tốc của Token Merging}
...
\subsection{Xử lý mất cân bằng và mở rộng dữ liệu}
...
\subsection{Khảo sát sâu hơn về LCF và chiến lược gộp}
